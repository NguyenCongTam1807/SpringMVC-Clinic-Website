        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="col-md-7 col-lg-8">
                    <h4 class="mb-3">Thêm loại thuốc</h4>

                    <s:form id="myForm" method="POST"  modelAttribute="medicinetype" action="${pageContext.request.contextPath}/manager/medicinetype/new">
                        <!-- input text code -->
