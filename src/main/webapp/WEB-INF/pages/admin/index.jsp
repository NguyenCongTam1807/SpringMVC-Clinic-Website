                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                         src="<%=request.getContextPath()%>/teamplate/admin/img/undraw_posting_photo.svg" alt="...">
                                </div>
...
<script src="<%=request.getContextPath()%>/teamplate/admin/vendor/chart.js/Chart.min.js"></script>
<script src="<%=request.getContextPath()%>/teamplate/admin/js/demo/chart-area-demo.js"></script>
<script src="<%=request.getContextPath()%>/teamplate/admin/js/demo/chart-pie-demo.js"></script>
