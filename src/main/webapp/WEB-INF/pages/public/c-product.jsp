              ...
              <div class="row">
                <div class="col-lg-3 col-md-4">
                  <div class="productblock product-list-wrap product-list">
                    <div class="Content"> <a href="${pageContext.request.contextPath}/san-pham/${item.id}"> <img class="img-fluid" src="${pageContext.request.contextPath}/img/${item.imgs[0].name}" alt=""> </a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-9 col-md-8">
                  <div class="product-list-view xs-mb-20">
                    <h5><a href="javascript:void(0)">${item.medicine_type.name}</a></h5>
...
<%--                      <p class="d-md-none d-lg-block">${item.description}</p>--%>
                    <a class="btn theme-button animated slideInRight" href="${pageContext.request.contextPath}/add-cart?id=${item.id}&quantity=1"><i class="fas fa-shopping-cart"></i> Thêm thuốc </a> </div>
                </div>
              </div>
            </c:forEach>
          </c:when>
